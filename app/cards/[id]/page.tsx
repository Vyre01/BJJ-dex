      ...
      <main className="max-w-xl mx-auto p-4">
        ...
        {t && (
          <article className="space-y-3">
            ...
            {t.details && (
              <div className="text-sm leading-relaxed [&_h1]:text-lg [&_h1]:font-bold [&_h1]:mt-3 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:mt-3 [&_p]:my-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:my-1 [&_code]:bg-gray-100 [&_code]:px-1 [&_code]:rounded [&_strong]:font-semibold">
